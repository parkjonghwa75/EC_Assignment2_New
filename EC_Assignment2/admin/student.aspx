<%@ Page Title="Student Details" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="EC_Assignment2.student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        ...
        <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Must be a Date"
            ...
            Type="Date" MinimumValue="2000-01-01" MaximumValue="2999-01-01"></asp:RangeValidator>
    </fieldset>
